...
function Profile_Update() {
    ...
    useEffect(() => {
        fetchData();
        document.title = 'profile_update page'
    })
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://seenunseendesign.com/seen_unseen/api/user/update_profile', {
    ...
    return (
        <>
            <div className=" w-full m-auto  flex items-center justify-center  ">
                ...
                <section class="rounded-md bg-black/80 p-2 mt-5">
                                    ...
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            <input
                                                ...
                                                id="password" onChange={(e) => setGender(e.target.value)}
                                            />
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div class="mt-2">
                                            <input
                                                ...
                                                type="password"
                                                placeholder="Password"
                                                id="password" onChange={(e) => setDOB(e.target.value)}
                                            />
                                        </div>
                                    </div>
                                    <div>
